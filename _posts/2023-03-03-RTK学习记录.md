...
搜索和配置的时候需要进入配置模式
透明广播：上位机配置
![image.png](https://img-blog.csdnimg.cn/img_convert/6c96fab5f5d22bc03bf74305215ea080.png#averageHue=#ebe9e89)
写入配置参数：
...
透明广播:串口配置
![image.png](https://img-blog.csdnimg.cn/img_convert/66652e3121e142f502ebe6c9e7ae71e0.png#averageHue=#dadad9)
基于模块的寄存器地址
...
REG   04 
LEN    07
![image.png](https://img-blog.csdnimg.cn/img_convert/fcd23daa1449d9540bf881ebdb9bc81c.png#averageHue=#cab9a3)
04  4    115200             00  01 C2 00
![image.png](https://img-blog.csdnimg.cn/img_convert/df62416e45cd8a910a9b3942219341bb.png#averageHue=#f4f6f6)
05  1    00
![image.png](https://img-blog.csdnimg.cn/img_convert/faac339eb1f21495edf2c260752b9240.png#averageHue=#fdfdfc)
06  2    02 9A
信道 20 功率 30dBm 空速 4.8k
0000 0010 100 11 010
![image.png](https://img-blog.csdnimg.cn/img_convert/2034ce87c2063b62f632319693e27a04.png#averageHue=#f6f7f7)
07  2     00 01    透传
![image.png](https://img-blog.csdnimg.cn/img_convert/3059255da641548ec041767283bc5b41.png#averageHue=#fcfbfa)
08  1     05       重传使能bit7 0  次数5
![image.png](https://img-blog.csdnimg.cn/img_convert/15a1138e29f18682a1148e5a842081e9.png#averageHue=#edecea)
09  2     00 64     100 ms重传
![image.png](https://img-blog.csdnimg.cn/img_convert/eaa3975aacedeab4ebffefea67956b0a.png#averageHue=#edeceb)
0A  1     00  
80 04 07 00 01 C2 00 00 02 9A 00 01 05 00 64 00
![image.png](https://img-blog.csdnimg.cn/img_convert/dd34f8067b1c52b8b1beddcb401b895a.png)
18   1      本地组号
19   1      本地地址
1A   1      目标组号
1B   1      目标地址
![image.png](https://img-blog.csdnimg.cn/img_convert/1087eecc38299fd39c2e214578fc47c5.png)
设置本地组号地址和目标组号地址
80  18  04   0A  0A  0A  0A

读取设备运行参数
00 04 1E 
![image.png](https://img-blog.csdnimg.cn/img_convert/594e7d23c6d1f510504369158f3ce858.png)

![image.png](https://img-blog.csdnimg.cn/img_convert/34162063eaefd5fc83957ee7d489488e.png)
主从模式：主机从机地址不能一样
上位机调试：主机com16  主机目标组号、地址无需设置，从机的目标组号、地址为主机的组号地址
![image.png](https://img-blog.csdnimg.cn/img_convert/b687580ccccd0a9f23ca622aab2aa913.png)
从机 com3       目标地址组号为主机
![image.png](https://img-blog.csdnimg.cn/img_convert/3f0fbeb0781d7661a587ab722c5114ea.png)
从机可以直接发送数据到主机，主机发送数据到从机时需要加上目标从机的组号地址【16 进制】，如果需要广播给所有从机在数据加上 16 进制 FFFF 即可
![image.png](https://img-blog.csdnimg.cn/img_convert/298f19335efb2abb6520f0267614499a.png)

配置参数图
![image.png](https://img-blog.csdnimg.cn/img_convert/775dd8a1ce36c85807af0f5d34542d56.png)
代码实现
...
```
运行截图记录
![image.png](https://img-blog.csdnimg.cn/img_convert/5ab464dd00f01a1805882a353bfbe22a.png)
经典的一秒延时
![image.png](https://img-blog.csdnimg.cn/img_convert/b1f2190f46fc87f58ced20d946123c76.png)
...
![image.png](https://img-blog.csdnimg.cn/img_convert/189f50f3792975a20ac827865784d756.png)
透传时本地组号和目标组号
TX：00  18  04
...
![image.png](https://img-blog.csdnimg.cn/img_convert/1a7ee7446ddddc9a67ac11fa1429b978.png)
![image.png](https://img-blog.csdnimg.cn/img_convert/86ae2ff63b0227cf9240eb5a9e311a9f.png)
![image.png](https://img-blog.csdnimg.cn/img_convert/0c96e60f90c684f708ebdf368f4e96d2.png)
TX：00 04 04
RX：00 04 04 00 01 C2 00 00 02 9A 00 01 
***自动配置大致完成不实现拨码条信道参数***
UM482模块
先看电器参数
![image.png](https://img-blog.csdnimg.cn/img_convert/20fa37ce6e82a01bee2680df54190166.png)
![1669254812928.jpg.jpg](https://img-blog.csdnimg.cn/img_convert/6f7de102a0222803e76089587efc960c.jpeg)
模块自检不通过现象