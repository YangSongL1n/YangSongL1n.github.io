...
const int baudRate = 56700;               //设置波特率
...
2.Ap 模式配置联网 掉电保存密码 第一次上电，esp32会开启自己的热点服务，你连接后手机会自动进入一个服务页面，然后进行密码配置，配置完成之后自动重启，重启后自动连接配置热点，到下次上电如果热点还在同样自动连接，不在再次进入配置模式，第二，如果说你想清楚原来的信息就长按boot键自动回复到第一次上电状态。
